...
<?php 
  if (isset($_GET)) {
     $id = $_GET['ID'];
     $query = "SELECT * FROM user_view_sub_adju_fp INNER JOIN adjudication_fp ON user_view_sub_adju_fp.subject_id = adjudication_fp.subject_id WHERE user_view_sub_adju_fp.subject_id='$id'";
