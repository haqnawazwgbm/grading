 ...
 ?>
  ...
  <?php 
   ...
   $run=mysqli_query($con,$q);
    ...
    if (isset($_GET['ID'])) {
      $id = $_GET['ID'];
      $query = "SELECT * FROM qec_oct where id='$id'";
                ...
                <div class="row">
                   <div class="col-sm-12">
                     <div class="col-sm-12">
                          ...
                          <form action="edit_oct_form.php" method="post">
                            <input type="hidden" value="<?= $oct['id']; ?>" name="oct_id">
                ...
                <br>
                 ...
                 <div class="row">
                   <div class="col-sm-6">
                    ...
                    <input type="submit" name="submit" value="Update Form " class="btn btn-info btn-lg">  
                 </div>
