            ...
            <section class="statistic statistic2">
                <div class="container">
                         <div class="row">
                             <div class="col-sm-6">
                              <h3>
                                <span><a href="field_form.php"><i class="fa fa-plus-square" aria-hidden="true"></i> Add CFP</a></span>
                            </h3>
                            <br>
                                     ...
                                     <tbody>
                                        ...
                                        while ($row=mysqli_fetch_array($run)) {
                                         ...
                                         <tr>
                                             ...
                                             <td><a href="field_form.php?ID=<?php echo $row['id'] ?>"><i class="fa fa-plus-square" aria-hidden="true"></i>Create</a></td>
                                         </tr>
                                     </tbody>
                                 <?php } ?>
                                 </table>
                             ...
                             <div class="col-sm-6">
                              <h3>
                                <span><a href="oct_form.php"><i class="fa fa-plus-square" aria-hidden="true"></i> Add OCT</a></span>
                            </h3>
                            <br>
                                     ...
                                     <tbody>
                                        ...
                                        while ($row=mysqli_fetch_array($run)) {
                                         ...
                                         <tr>
                                             ...
                                             <td><?php echo $row['study_site'] ?></td>
                                             <td><?php echo $row['visit_name'] ?></td>
                                             <td><a href="oct_form.php?ID=<?php echo $row['id'] ?>"><i class="fa fa-plus-square" aria-hidden="true"></i>Create</a></td>
                                         </tr>
                                     </tbody>
                                 <?php } ?>
                                 </table>
