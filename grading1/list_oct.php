                                 ...
                                 <table class="table table-hover table-bordered">
                                     ...
                                     <tbody>
                                        <?php 
                                          ...
                                          $user_id = $_SESSION['ID'];
                                        $query="SELECT * FROM grading1_oct INNER JOIN oct_formula ON grading1_oct.subject_id = oct_formula.subject_id INNER JOIN delta ON grading1_oct.subject_id = delta.subject_id WHERE user_id = '$user_id'";
