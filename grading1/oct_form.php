 ...
 ?>
  ...
  <?php 
   ...
   $run=mysqli_query($con,$q);
    ...
    if (isset($_GET['ID'])) {
      $id = $_GET['ID'];
      $query = "SELECT * FROM user_id_subject_g1_oct INNER JOIN qec_oct ON user_id_subject_g1_oct.subject_id = qec_oct.subject_id WHERE user_id_subject_g1_oct.subject_id='$id'";
                    ...
                    <div class="col-sm-6">
                      <table class="table-bordered" style="font-size: 12px;">
                                 ...
                                 <tbody> 
                                     <tr>
                                         ...
                                         <td>
                                          <input type="text" name="retinal_od"  class="form-control" id="retinalod"  onblur="showOD();">  

                                         </td>
                                         <td>
                                         <input type="text" name="retinal_os" class="form-control"  id="retinalos" onblur="showOS();" >   
                                     ...
                                     <tr>
                                       <td><label>Total Volume (mm3)</label></td> 
                                        <td>
                                          <input type="text" name="total_volume_od" class="form-control"> 
                                         

                                          </td>

                                          <td>
                                          <input type="text" name="total_volume_os" class="form-control" > 
                      ...
                      <table class="table-bordered" style="font-size: 12px;">
                        ...
                        Spectralis Optical Coherence Tomography (SD-OCT) <br> CST ≥305 μm in women and ≥320 μm <br> in men in the study eye (Inclusion)
                                         ...
                                         <td>
                                        <input type="radio" name="optical_choerence_od" value="Yes">Yes
                                        <input type="radio" name="optical_choerence_od" value="No"> No <br>
                                        <input type="radio" name="optical_choerence_od" value="Cannot Grade"> Cannot Grade <br>
                                          
                                         </td>
                                         <td>
                                          <input type="radio" name="optical_choerence_os" value="Yes">Yes
                                        <input type="radio" name="optical_choerence_os" value="No"> No <br>
                                        <input type="radio" name="optical_choerence_os" value="Cannot Grade"> Cannot Grade
                                     ...
                                     <tr>
                                       <td><label>Is the eye eligible based on the OCT findings?</label></td> 
                                        <td>
                                          <input type="radio" name="oct_finding_od" value="Yes">Yes
                                          <input type="radio" name="oct_finding_od" value="No"> No
                                         

                                          </td>

                                          <td>
                                       <input type="radio" name="oct_finding_os" value="Yes">Yes
                                        <input type="radio" name="oct_finding_os" value="No"> No
                                    ...
                                    <tr>
                                      ...
                                      <td colspan="3"><textarea class="form-control" name="comments"></textarea></td>
                                    </tr>
...
$Sql="INSERT INTO grading1_oct (subject_id,user_id,visit_name,Date_visit,study_site,images_received,images_gradable,etdrs_grid,imaging_protocol,no_please_explain,rpe_ilm,   yes_please_specify,yes_please_specify_os,retinal_thickness,total_volume,optical_choerence_od,oct_finiding_od,images_gradable_os,
etdrs_grid_os,imaging_protocol_os,no_please_explain_os,rpe_ilm_os,retinal_thickness_os,total_volume_os,optical_choerence_os,oct_finiding_os,comments)

 VALUES('$SubjectID','$UserId','$VisitName','$visit_date','$study_site','$ImageRecived','$ImageGradable','$EtdrsGirdOD','$ImagingProtocolOD','$NoQuestionOD','$RpeIimOD','$yes_please_specify','$yes_please_specify_os','$RetinalOD','$TotalVolumeOD','$OpticalTomographOD','$OCTFIndingOD','$ImageGradableOS','$EtdrsGirdOS','$ImagingProtocolOS','$NoQuestionOD','$RpeIimOS','$RetinalOS','$TotalVolumeOS','$OpticalTomographOS','$OCTFIndingOS','$Coments')";
