...
<?php 
  if (isset($_GET)) {
     $id = $_GET['ID'];
     $query = "SELECT * FROM user_id_subject_g2 INNER JOIN qec_fp ON user_id_subject_g2.subject_id = qec_fp.subject_id WHERE user_id_subject_g2.subject_id='$id'";
