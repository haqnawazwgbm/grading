  ...
  <div class="page-content--bgf7">
            ...
            <section class="statistic statistic2">
                <div class="container">
                         <div class="row">
                             <div class="col-sm-12">
                                <h3 class="text-info">LIST OCT</h3>
                                 <table class="table table-hover table-bordered">
                                     ...
                                     <tbody>
                                        <?php 
                                          ...
                                          $user_id = $_SESSION['ID'];
                                        $query="SELECT * FROM grading2_oct INNER JOIN oct_formula ON grading2_oct.subject_id = oct_formula.subject_id INNER JOIN delta ON grading2_oct.subject_id = delta.subject_id WHERE user_id = '$user_id'";
                                        ...
                                        while ($row=mysqli_fetch_array($run)) {
                                         ...
                                         <tr>
                                             ...
                                             <td><?php if ($row['delta'] >= 30 || $row['delta'] > 1 && $row['delta'] < 15) : ?><a href="edit_oct_form.php?ID=<?php echo $row['id'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a><?php endif; ?></td>
                                             <td><?= $row['delta'] >= 30 ? $row['Retinal_thickness_os'] : ''; ?></td>
                                         </tr>
                                     </tbody>
                                 <?php } ?>
                                 </table>
