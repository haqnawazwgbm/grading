 ...
 ?>
  ...
  <?php 
   ...
   $run=mysqli_query($con,$q);
    ...
    if (isset($_GET['ID'])) {
      $id = $_GET['ID'];
      $query = "SELECT * FROM user_id_subject_g2_oct INNER JOIN qec_oct ON user_id_subject_g2_oct.subject_id = qec_oct.subject_id WHERE user_id_subject_g2_oct.subject_id='$id'";
...
$Sql="INSERT INTO grading2_oct (subject_id,user_id,visit_name,Date_visit,study_site,images_received,images_gradable,etdrs_grid,imaging_protocol,no_please_explain,rpe_ilm,   yes_please_specify,yes_please_specify_os,retinal_thickness,total_volume,optical_choerence_od,oct_finiding_od,images_gradable_os,
